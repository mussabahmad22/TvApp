            ...
            <div class="card z-index-0 fadeIn3 fadeInBottom">
              <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                <div class="shadow-primary border-radius-lg py-3 pe-1" style="background-color: #525d79 !important">
                  ...
                  <p class="text-white  text-center text-sm mt-2 mb-3 mx-3">Forgot your password? No problem. Just let us know your email address and we will email you a password reset link that will allow you to choose a new one.</p>
                </div>
              </div>
              <div class="card-body">
                <form role="form" class="text-start" action="{{ route('forget.password.post') }}" method="post">
                 @csrf    
                ...
                <x-auth-validation-errors class="mb-4 text-danger" :errors="$errors" /> --}}
                  ...
                  <div class="input-group input-group-outline mb-3">
                    ...
                    <input name="email" id="email_address" type="email" class="form-control" placeholder="Enter your email">
                  </div>
                  @if ($errors->has('email'))
                  ...
                  <div class="text-center">
                    ...
                    <button type="submit" class="btn text-white w-100 my-4 mb-2" style="background-color: #525d79 !important">Send Password Reset Link</button>
